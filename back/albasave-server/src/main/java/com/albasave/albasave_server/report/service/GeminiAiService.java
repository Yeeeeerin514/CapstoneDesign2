...
public class GeminiAiService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            5. '사업주와의 협의 정황'이 제공된 경우, 그 사실을 마지막 문단(이행 요청) 근처에 자연스럽게
               녹여 서술합니다. 단, 제공된 문구를 그대로 옮기지 말고 진정서 문체로 새로 풀어 씁니다.
               제공되지 않았다면("(미입력)") 협의 관련 내용은 언급하지 않습니다.
            6. 감정적 표현 없이 객관적으로 기술하고, 마지막 문단에서 체불 임금의 지급 등 이행을 요청합니다.
            7. 관련 법적 근거(근로기준법 등)는 일반적으로 확립된 범위에서만 괄호로 덧붙일 수 있습니다.
            8. 전체 분량 300자 이내, 제목·머리말·맺음말 없이 본문만 한국어로 작성합니다.

            [원하는 문체 예시]
            "진정인은 2020년 3월 5일부터 OO에서 근무하였습니다. 그러나 피진정인은 기본급과 주휴수당 등
            합계 120,000원을 현재까지 지급하지 않고 있습니다. 이에 진정인은
    ...
    private String buildUserMessage(AiDraftContext ctx) {
        ...
        return String.format("""
                ...
                - 사업주와의 협의 정황(그대로 베끼지 말고 격식체로 재서술, "(미입력)"이면 언급하지 말 것): %s
                """,
